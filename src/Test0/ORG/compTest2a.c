...
"$Revision: icc_3.1-1-g37d7c8e-dirty $ -O7";
...
#error "iC: Action gate 'QB57_3' has no valid clock"
 {&iC_l_[1034]}, &QB57_2 };
...
#error "iC: Action gate 'QB58_1' has no valid clock"
 {&iC_l_[1047]}, &QB58_0 };
iC_Gt QB58_2   = { 1, -iC_AND, iC_S_SH, 0, "QB58_2", {&iC_l_[1052]},
#error "iC: Action gate 'QB58_2' has no valid clock"
 {&iC_l_[1055]}, &QB58_1 };
iC_Gt QB58_3   = { 1, -iC_AND, iC_R_SH, 0, "QB58_3", {&iC_l_[1059]},
#error "iC: Action gate 'QB58_3' has no valid clock"
 {&iC_l_[1061]}, &QB58_2 };
...
#error "iC: Action gate 'QB59_1' has no valid clock"
 {&iC_l_[1074]}, &QB59_0 };
iC_Gt QB59_2   = { 1, -iC_AND, iC_S_SH, 0, "QB59_2", {&iC_l_[1079]},
#error "iC: Action gate 'QB59_2' has no valid clock"
 {&iC_l_[1082]}, &QB59_1 };
iC_Gt QB59_3   = { 1, -iC_AND, iC_R_SH, 0, "QB59_3", {&iC_l_[1086]},
#error "iC: Action gate 'QB59_3' has no valid clock"
 {&iC_l_[1088]}, &QB59_2 };
...
#error "iC: Action gate 'QX0.5_1' has no valid clock"
 {&iC_l_[1125]}, &QX0_5_0 };
...
#error "iC: Action gate 'QX0.6_1' has no valid clock"
 {&iC_l_[1133]}, &QX0_6_0 };
...
#error "iC: Action gate 'QX0.7_1' has no valid clock"
 {&iC_l_[1141]}, &QX0_7_0 };
...
#error "iC: Action gate 'QX1.1_1' has no valid clock"
 {&iC_l_[1171]}, &QX1_1_0 };
iC_Gt QX1_1_2  = { 1, -iC_OR, iC_R_FF, 0, "QX1.1_2", {&iC_l_[1175]},
#error "iC: Action gate 'QX1.1_2' has no valid clock"
 {&iC_l_[1177]}, &QX1_1_1 };
...
#error "iC: Action gate 'QX1.2_1' has no valid clock"
 {&iC_l_[1193]}, &QX1_2_0 };
iC_Gt QX1_2_2  = { 1, -iC_OR, iC_R_FF, 0, "QX1.2_2", {&iC_l_[1197]},
#error "iC: Action gate 'QX1.2_2' has no valid clock"
 {&iC_l_[1199]}, &QX1_2_1 };
...
#error "iC: Action gate 'QX1.3_1' has no valid clock"
 {&iC_l_[1215]}, &QX1_3_0 };
iC_Gt QX1_3_2  = { 1, -iC_OR, iC_R_FF, 0, "QX1.3_2", {&iC_l_[1219]},
#error "iC: Action gate 'QX1.3_2' has no valid clock"
 {&iC_l_[1221]}, &QX1_3_1 };
...
#error "iC: Action gate 'QX1.4_1' has no valid clock"
