...
"#define " LVL "(n)	(iC_pf0_1->gt_list[n]->gt_val < 0 ? 1 : 0)\n"
"#define " AAL "(n,p,v)	iC_assignA(iC_pf0_1->gt_list[n], p, v)\n"
"#define " LAL "(n,p,v)	iC_assignL(iC_pf0_1->gt_list[n], p, v)\n"
"#define " AVIL "(n,i)	iC_index(iC_pf0_1->gt_list[n], i)->gt_new\n"
"#define " LVIL "(n,i)	(iC_index(iC_pf0_1->gt_list[n], i)->gt_val < 0 ? 1 : 0)\n"
"#define " AAIL "(n,i,p,v) iC_assignA(iC_index(iC_pf0_1->gt_list[n], i), p, v)\n"
"#define " LAIL "(n,i,p,v) iC_assignL(iC_index(iC_pf0_1->gt_list[n], i), p, v)\n"
