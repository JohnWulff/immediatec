...
#define	MAX_ACT	TRAB	/* ftypes >= MAX_ACT never cause an action */
...
#define	FULL_TYPE "UDF","ARNC","ARN","LOGC","AND","OR","LATCH",\
	"SH","FF","VF","EF","SW","CF","NCONST","INPB","INPW","INPX",\
...
#define	FTYPES	UDFA, ARITH, ARITH, GATE, GATE, GATE, GATE,\
	D_SH, D_FF, CH_BIT, RI_BIT, F_SW, F_CF, ARITH, OUTX, ARITH, TRAB,\
...
#define	DEF_TYP	YYERRCODE, AVARC, YYERRCODE, LVARC, YYERRCODE, YYERRCODE, YYERRCODE,\
	...
	YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE,
...
#define	DEF_ACT	UNDEF, AVAR, LVAR, YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE,\
	YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE, YYERRCODE, AOUT, LOUT,\
	CVAR, TVAR
...
extern Gate *		c_list;
extern Gate *		f_list;
extern Gate *		s_list;		/* send bit and byte outputs */
...
extern int	traMb(Gate *, Gate *);	/* TRAB master action */
...
extern void	scan(Gate *);		/* scan logic action list */
extern void	scan_ar(Gate *);	/* scan arithmetic action list */
extern void	scan_clk(Gate *);	/* scan a clock list */
