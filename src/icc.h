...
"@(#)$Id: icc.h,v 1.57 2005/01/28 10:36:41 jw Exp $";
...
#define	OPS	".-+\"^&|%*#/v({=][<:!@?ktwi"	/* DEBUG display of types */
...
extern char *		iC_full_type[];
extern char *		iC_full_ftype[];
extern unsigned char	iC_types[];
extern unsigned char	iC_ctypes[];
extern unsigned char	iC_ftypes[];
extern char		iC_os[];
extern char		iC_fos[];
...
extern unsigned short	iC_Tflag;	/* define iC_tVar */
					...
					/*   main.c   */
extern const char *	iC_progname;	/* name of this executable */
