...
static struct bi builtins[] = {
  ...
  { "SRR_",	KEYW,	BLTIN3,	S_FF,	}, /* R_FF for reset master */
  { "if",	KEYW,	IF,	F_CF,	},
  { "else",	KEYW,	ELSE,	F_CE,	},
  ...
  { "IF",	KEYW,	LEXERR,	0,	}, /* keyword used in immac IF statements */
  { "ELSE",	KEYW,	LEXERR,	0,	}, /* keyword used in immac ELSE statements */
  { "ELSIF",	KEYW,	LEXERR,	0,	}, /* keyword used in immac ELSIF statements */
